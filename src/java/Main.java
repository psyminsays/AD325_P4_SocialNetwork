        ...
        while (!exit) {
            ...
            switch (userIntChoice) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.println("Add method for viewing your friend's friend list");
                    break;
                case 8:
                    System.out.println("Add method for deleting a profile");
                    break;
                case 9:
                    System.out.println("Add method for adding a profile");
                    break;
                case 10:
                    System.out.println("Add method for switching the current user");
                    break;
                case 11:
                    System.out.println("Add method for logging out");
            }
        }
    }
